...
## Project overview
Full Stack Banking web app made with Full Stack JavaScript using the PERN Tech Stack. Status(WIP) <br> 
technologies used: JavaScript language, Bootstrap, Express, React for frontend, and NodeJS framworks, Backend: PostgreSQL<br>
